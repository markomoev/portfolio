...
export default function Skills(){
    ...
    return(
        <div className="w-full py-12">
            <div className="w-full bg-slate-950 rounded-[2.5rem] py-24 text-slate-100 shadow-xl overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 min-h-125 lg:min-h-screen relative mt-16 lg:mt-0 flex items-center justify-center p-8 lg:p-24">
                     {/* The Image Container */}
                    <div className="relative w-full h-full min-h-100 bg-slate-950 rounded-2xl overflow-hidden shadow-2xl border border-slate-800">
