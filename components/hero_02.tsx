      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="hidden lg:block relative h-64 w-full rounded-2xl overflow-hidden bg-slate-200 border border-slate-200/50 p-6">
          ...
          <div className="space-y-8 pl-0 lg:pl-12 border-l-0 lg:border-l border-slate-200">
